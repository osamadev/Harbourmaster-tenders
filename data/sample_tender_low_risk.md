# Invitation to Tender — ITT-2026-0552

## Office Stationery and Print Supply — Central District (Synthetic Sample)

*This is a synthetic document for demonstration only. It is deliberately
balanced and low-risk so the analyst agent has little to flag and the workflow
should pass through without human review.*
...
Either party may propose changes to scope, volume, or delivery locations in
writing. Any agreed change shall be priced in line with Schedule 2 (unit rates)
and confirmed by a signed change note before it takes effect.

### 3. Liability and Indemnity
Each party's total aggregate liability under or in connection with this
contract shall not exceed one hundred and twenty-five per cent (125%) of the
fees paid or payable in the twelve (12) months preceding the event giving rise
to the claim. Neither party shall be liable for indirect or consequential loss,
loss of profit, or loss of goodwill, except in cases of wilful misconduct or
fraud.
...
### 7. Service Levels
The Contractor shall meet the following service levels:

- Standard orders delivered within five (5) business days.
- Order accuracy of at least 98% by line item per quarter.
...
### 10. Insurance
The Contractor shall maintain, at its own cost, public liability insurance of
not less than GBP 2,000,000 per occurrence and professional indemnity insurance
of not less than GBP 1,000,000 in the aggregate, and shall provide certificates
of cover on reasonable request.

### 11. Governing Law and Disputes
This contract shall be governed by the laws of England and Wales. The parties
shall first attempt in good faith to resolve any dispute by senior-level
negotiation within thirty (30) days, failing which either party may refer the
dispute to the courts of England and Wales.
